...
function Index() {
  ...
  return (
    <main>
      ...
      <p><ol>
        <li>pending: a BSD3 federated markets browser platform application with cryptocurrencies trading and exchanges &mdash; an android app with an <a href="https://i2pd.website/" target="_blank" rel="noopener" rel="noreferer">i2pd crystal</a> inside, with an open host architecture: your i2p hosts would be having a pluggable serverside BSD3 multi-platform i2p protocols api libraries to be used for implementing the i2p server hosts, or alternatively you would be able to use our specifications for json-based http i2p protocol, and more performant protocols in the future;</li>
